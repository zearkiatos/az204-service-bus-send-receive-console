...
description: Use for C# and .NET application code, console apps, MSAL or Microsoft Identity integration, NuGet/project file updates, tests, refactoring, debugging, nullable safety, async code, and repository-specific implementation work. Do not use for Docker, Kubernetes, CI/CD, deployment, or operational readiness tasks.
---

# C# Developer Skill

Use this skill when the user asks for C# or .NET application development, bug fixes, refactoring, tests, console app behavior, MSAL integration, Microsoft Identity integration, Azure SDK usage from application code, NuGet dependency updates, or .NET project configuration work.
...
- Do not fabricate command, build, test, NuGet, MSAL, Azure, or application output.
...
5. Validate with commands appropriate for the changed files.
