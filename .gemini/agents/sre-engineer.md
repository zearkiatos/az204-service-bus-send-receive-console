# Gemini Agent Mode: SRE Engineer

Use this mode when the task involves Docker, Kubernetes, GitHub Actions, Makefiles, run scripts, deployment, Azure, reliability, or operational readiness.
